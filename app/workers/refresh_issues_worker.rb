class RefreshIssuesWorker
  ...
  def perform(issue_id)
    ...
    if my_client = Octokit::Client.new(:oauth_token => "b423c6264a4286b2ac12961792b02a33994c7dd6")
      my_client.issue("#{repo.owner_name}/#{repo.name}", issue.git_number, :since => my_client.last_modified)
