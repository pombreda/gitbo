...
class ReposControllerTest < ActionController::TestCase
  ...
  test "should create repo" do
    assert_difference('Repo.count') do
      post :create, repo: { description: @repo.description, name: @repo.name, open_issues: @repo.open_issues, owner_name: @repo.owner_name, watchers: @repo.watchers }
    end
  ...
  test "should update repo" do
    put :update, id: @repo, repo: { description: @repo.description, name: @repo.name, open_issues: @repo.open_issues, owner_name: @repo.owner_name, watchers: @repo.watchers }
    assert_redirected_to repo_path(assigns(:repo))
  end
